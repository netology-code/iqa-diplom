...
Написать чек-лист для функциональной проверки профиля (кнопка в правой нижней части)  сайта [зарегистрированного  пользователя](https://henderson.ru/cabinet/), включая функционал изменения личных данных, клубной карты, уведомлений и выхода. 
