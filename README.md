...
Написать чек-лист для функциональной проверки профиля (кнопка в правой нижней части)  сайта зарегистрированного  пользователя, включая функционал изменения личных данных, клубной карты, уведомлений и выхода. 
...
* При составлении списка проверок должны учитываться различные варианты состояний пользовательского пути и состояния.
...
3.2.* Найдите баг в функции фильтров в поиске на сайте и составьте на него баг-репорт. Если найдёте несколько — замечательно!
