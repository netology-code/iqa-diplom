...
1. Все таблицы должны быть отформатированы с переносами и правильной версткой, иначе они будут возвращены на допроверку. Пример можно увидеть [тут](https://docs.google.com/document/d/1yDj9YWZ6wF7v8edq_aJkSFR9g7QgUil5yuuZgbHDzvE/edit?usp=sharing)
