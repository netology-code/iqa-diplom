...
Написать чек-лист для функциональной проверки профиля [кнопка в правой нижней части](https://disk.360.yandex.ru/i/ao220BUteS_29Q)  сайта [зарегистрированного авторизованного пользователя](https://henderson.ru/cabinet/), включая функционал изменения личных данных, клубной карты, уведомлений и выхода. 
